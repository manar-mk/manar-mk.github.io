...
window.onload = function() {
    ...
    for (var k = 0; k < e.length; k++) {
        if (e[k].className.indexOf('share42init') != -1) {
            ...
            var fbLink="<a href="+s[0]+" class='social-ribbon__link' ><img src='img/story__fb.png'></a>";
            var mailLink="<a href="+s[1]+" class='social-ribbon__link' ><img src='img/story__email.png'></a>";
            var twLink="<a href="+s[2]+" class='social-ribbon__link' ><img src='img/story__tw.png'></a>";
            var vkLink="<a href="+s[3]+" class='social-ribbon__link' ><img src='img/story__vk.png'></a>";
